...
<script>
  ...
  $(function() {
    ...
    $('#save').click(function() {
      ...
      $.ajax({
        type: 'post',
        url: '<?= site_url('sekretaris/DataSiswa/addSiswa') ?>',
        contentType: false,
        processData: false,
        dataType: 'json',
        data: data,
    ...
    tableSiswa = $('#dataSiswa').DataTable({
      ...
      "order": [],
      "ajax": {
        url: "<?= site_url('sekretaris/DataSiswa/getSiswa') ?>",
      },
      buttons: [
        'excel'
      ],
  ...
  function nisAvail() {
    ...
    $.ajax({
      type: "post",
      url: "<?= site_url('sekretaris/DataSiswa/nisValid') ?>",
      data: {
        nis: nis
      },
  ...
  function hapusSiswa(id) {
    swal({
      ...
      .then((willDelete) => {
        if (willDelete) {
          $.ajax({
            url: "<?= site_url('sekretaris/DataSiswa/hapusSiswa/') ?>" + id,
            type: "post",
            dataType: "json",
            success: function(data) {
